...
{
    output << left << setw(10) << good.getNumber() << setw(30) << good.getName() << setw(5) << good.getQuantity() << right << setw(10) << setprecision(2) << fixed << showpoint << good.getPrice() << endl;
}
void createTextFile(fstream& readFF)
{
    ...
    textFile << left << setw(10) << "Number" << setw(30) << "Name" << setw(5) << "Quantity" << right << setw(10) << "Price" << endl;
    readFF.seekg(0);
